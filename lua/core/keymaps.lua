...
-- [[ Basic Keym-- [[ Basic Keymaps ]]
--  See `:help vim.keymap.set()`

-- Set highlight on search, but clear on pressing <Esc> in normal mode
vim.keymap.set("n", "<Esc>", "<cmd>nohlsearch<CR>")
vim.keymap.set("n", "<Esc><Esc>", utils.close_floating)
...
vim.keymap.set("n", "gn", ":split<cr>", { desc = "split pane" })
vim.keymap.set("n", "gv", ":vsplit<cr>", { desc = "split pane vertically" })
